 ...
 */
final class Version20230913151102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bulletin ADD eleve_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2B7D8942A6CC7B2 ON bulletin');
        $this->addSql('ALTER TABLE bulletin DROP eleve_id');
    }
}
